...
rem Set moniker and chain-id for Visca (Moniker can be anything, chain-id must be an integer)
...
viscad start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001aphoton