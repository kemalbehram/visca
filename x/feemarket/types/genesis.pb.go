...
// source: visca/feemarket/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "visca.feemarket.v1.GenesisState")
}

func init() {
	proto.RegisterFile("visca/feemarket/v1/genesis.proto", fileDescriptor_6241c21661288629)
}
