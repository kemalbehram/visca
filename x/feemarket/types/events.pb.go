...
// source: visca/feemarket/v1/events.proto
...
func init() {
	proto.RegisterType((*EventFeeMarket)(nil), "visca.feemarket.v1.EventFeeMarket")
	proto.RegisterType((*EventBlockGas)(nil), "visca.feemarket.v1.EventBlockGas")
}

func init() {
	proto.RegisterFile("visca/feemarket/v1/events.proto", fileDescriptor_c6edce8d670faff7)
}
