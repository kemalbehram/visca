...
// source: visca/evm/v1/events.proto
...
func init() {
	proto.RegisterType((*EventEthereumTx)(nil), "visca.evm.v1.EventEthereumTx")
	proto.RegisterType((*EventTxLog)(nil), "visca.evm.v1.EventTxLog")
	proto.RegisterType((*EventMessage)(nil), "visca.evm.v1.EventMessage")
	proto.RegisterType((*EventBlockBloom)(nil), "visca.evm.v1.EventBlockBloom")
}

func init() { proto.RegisterFile("visca/evm/v1/events.proto", fileDescriptor_432e0d592184bde3) }
