...
The `x/evm` is part of the [visca library](https://pkg.go.dev/github.com/onchainengineer/visca). For an example of how Visca can be used on any Cosmos-SDK chain, please refer to [Visca](https://www.github.com/onchainengineer/visca).
