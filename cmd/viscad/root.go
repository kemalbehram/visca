...
import (
	...
	viscaclient "github.com/onchainengineer/visca/client"
	"github.com/onchainengineer/visca/client/debug"
	...
	"github.com/onchainengineer/visca/server"
	servercfg "github.com/onchainengineer/visca/server/config"
	srvflags "github.com/onchainengineer/visca/server/flags"
	visca "github.com/onchainengineer/visca/types"
)

const EnvPrefix = "VISCA"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig(visca.AttoPhoton)
	...
	rootCmd.AddCommand(
		...
		viscaclient.NewTestnetCmd(app.ModuleBasics, banktypes.GenesisBalancesIterator{}),
		debug.Cmd(),
		config.Cmd(),
	)
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		viscaclient.KeyCommands(app.DefaultNodeHome),
	)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		viscaApp = app.NewViscaApp(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := viscaApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		viscaApp = app.NewViscaApp(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}
