...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*visca.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*visca.TxResult, error)
...
func NewBackend(
	...
	chainID, err := visca.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
