def test_single_request_netversion(visca):
    visca.use_websocket()
    eth_ws = visca.w3.provider
...
def test_batch_request_netversion(visca):
    return


def test_ws_subscribe_log(visca):
    return


def test_ws_subscribe_newheads(visca):
    return
