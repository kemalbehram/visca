// This is a test utility for Visca's Web3 JSON-RPC services.
//
// To run these tests please first ensure you have the viscad running
// and have started the RPC service with `viscad rest-server`.
//
...
func TestEth_protocolVersion(t *testing.T) {
	expectedRes := hexutil.Uint(visca.ProtocolVersion)
