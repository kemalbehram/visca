...
// source: visca/types/v1/account.proto
...
func init() {
	proto.RegisterType((*EthAccount)(nil), "visca.types.v1.EthAccount")
}

func init() { proto.RegisterFile("visca/types/v1/account.proto", fileDescriptor_4edc057d42a619ef) }
