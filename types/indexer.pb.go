...
// source: visca/types/v1/indexer.proto
...
func init() {
	proto.RegisterType((*TxResult)(nil), "visca.types.v1.TxResult")
}

func init() { proto.RegisterFile("visca/types/v1/indexer.proto", fileDescriptor_1197e10a8be8ed28) }
