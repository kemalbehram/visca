...
// source: visca/types/v1/web3.proto
...
func init() {
	proto.RegisterType((*ExtensionOptionsWeb3Tx)(nil), "visca.types.v1.ExtensionOptionsWeb3Tx")
}

func init() { proto.RegisterFile("visca/types/v1/web3.proto", fileDescriptor_9eb7cd56e3c92bc3) }
