...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "visca_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "VISCA_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Visca_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "visca_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "visca_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "visca_visca_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "visca_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "visca_" + strings.Repeat("1", 40) + "-1", true, nil,
		},
	}
