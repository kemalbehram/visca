...
// source: visca/types/v1/dynamic_fee.proto
...
func init() {
	proto.RegisterType((*ExtensionOptionDynamicFeeTx)(nil), "visca.types.v1.ExtensionOptionDynamicFeeTx")
}

func init() {
	proto.RegisterFile("visca/types/v1/dynamic_fee.proto", fileDescriptor_9d7cf05c9992c480)
}
